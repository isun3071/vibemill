...
### 6. Do not add after deployment monitoring or alerting
...
**The cemetery is the only after deployment record.** Apps die on schedule, archived with whatever bugs they had at end of life. No remediation.
...
- Adding after deployment monitoring or alerting (the indifference posture flips to product-care; see rule 6)
...
- Collapsing the voice palette (the seven the recent calibration work voices) to a single voice fine-tuned or prompted to match one user's prose style
